...
const twitchCltId = config.TwitchCredentials.twitchCltId,
      ...
      responseStr = "https://id.twitch.tv/oauth2/authorize?response_type=code&client_id=" + twitchCltId + "&redirect_uri=" + redirectUri + "&scope=channel_editor+chat:read+channel:moderate+user:read:email+bits:read+clips:edit&state=" + randState;
